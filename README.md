...
<h1 align="center">holo  <img src="https://media.giphy.com/media/hvRJCLFzcasrR4ia7z/giphy.gif" width="35">,yo soySebastian Franco Cruz</h1>
...
- :Nivel_de_Escuela: mi nivel de estudio es `tecologo enanalisis y desarollo de software` en [(sena)sentro de diseño y manofactura del cuero](https://oferta.senasofiaplus.edu.co/sofia-oferta/) 
- :technologist:el desarrollo de software le puede dar solucion acasi todo `Problem`.
